...
function setupDom() {
  ///in - Auto shrink Title to fit a width and reposition
    ...
    TweenLite.set(creative.title, {
        x:(bannerWidth-myWidth)/2,
    })
...
function repositionPrices(){
      var spacerY = 0 
      creative.priceNew.style.top = title.bottom + spacerY + 'px';
      creative.priceOld.style.top = title.bottom + spacerY + 'px';
      //
      var spacerX = 12
